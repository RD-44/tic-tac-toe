...
if TYPE_CHECKING:
    from tic_tac_toe.logic.models import GameState, Grid, Mark # handles circular imports
...
def validate_winner(grid : Grid, starting_mark : Mark, winner) -> None:  # winner is None or Mark
    if winner == 'X':
        if starting_mark == 'X':
